...
if __name__ == '__main__':
    ...
    # pprint(f"train_images[:1] = \n{train_images[:1]}")
    # pprint(train_images[:1])
    # Likewise, there are 60,000 labels in the training set:
    print(f"len(train_labels) = {len(train_labels)}")

    # Each label is an integer between 0 and 9:
    print(f"train_labels = {repr(train_labels)}")
    ...
    # than it does on the training data.
    ...
    #     <https://tensorflow.google.cn/tutorials/keras/overfit_and_underfit#strategies_to_prevent_overfitting>
    ...
    print(f"predictions[0] = {repr(predictions[0])}")
